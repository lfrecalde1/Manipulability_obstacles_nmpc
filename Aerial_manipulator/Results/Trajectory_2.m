...
%% Legend nomeclature
hLegend_1 = legend([hd_plot, h_plot, h_plot_p, Obstacle_1 ],{'$\mathbf{\eta}_d$','$\mathbf{\eta}_a$','$\mathbf{\eta}_p$', '$Obs$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','northwest','NumColumns',1,'TextColor','black');
...
%% Legend nomeclature
hLegend_2 = legend([hd_plot_2, h_plot_2, h_plot_p_2, Obstacle_1],{'$\mathbf{\eta}_d$','$\mathbf{\eta}_a$','$\mathbf{\eta}_p$','$Obs$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','northwest','NumColumns',1,'TextColor','black');
set(gca,'ticklabelinterpreter','latex',...
        'fontsize',1.0*fontsizeTicks)
% Figure properties
ax_2 = gca;
...
%% Legend nomeclature
hLegend_10 = legend([hd_plot_10, h_plot_10, h_plot_p_10, Obstacle_1],{'$\mathbf{\eta}_d$','$\mathbf{\eta}_a$','$\mathbf{\eta}_p$','$Obs$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','northwest','NumColumns',1,'TextColor','black');
set(gca,'ticklabelinterpreter','latex',...
        'fontsize',1.0*fontsizeTicks)
...
%% Legend nomeclature
hLegend_3 = legend([error_x_plot,error_y_plot, error_z_plot],{'$\tilde{\mathbf{\eta}}_x$','$\tilde{\mathbf{\eta}}_y$','$\tilde{\mathbf{\eta}}_z$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','southeast','NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',1.0*fontsizeTicks)
%% Figure properties
ax_3 = gca;
...
%% Legend nomeclature
hLegend_4 = legend([Obstacles_plot],{'$l_{Obs_1}$','$l_{Obs_2}$','$l_{Obs_3}$','$l_{Obs_4}$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','southeast','NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',1.0*fontsizeTicks)
%% Figure properties
ax_4 = gca;
...
export_fig Results_trajectoria_2.pdf -q101
